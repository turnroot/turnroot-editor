let beastRows = [
    ...
    {left: 'snow', right: ['move', 'slow*2', 'see']},
    ...
    {left: 'bushes', right: ['move', 'see', 'avoid*1']},
    {left: 'trees', right: ['move', 'see', 'avoid*1.5']},
    {left: 'boulder', right: ['stop', 'see']},
    {left: 'fence', right: ['stop', 'see']},
    {left: 'forest', right: ['move', 'avoid*2', 'hidden']},
    {left: 'fog', right: ['move', 'see', 'hidden']},
    {left: 'mist', right: ['move', 'see', 'hidden']},
]

export default beastRows